...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    #   it "ignores missing params" do
    #     post :create, params: {question: invalid_attributes}, session: valid_session
    #     # expect(assigns(:question)).to have_attributes(:content => nil, :answer => nil)
    #     expect(assigns(:question)).not_to have_attributes(:blah => "I hope so")
    #   end
    # end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {
          content: 'Has this example question been changed?'
        }
      }
      ...
      it "updates the requested question" do
        ...
        question.reload
        expect(question).to have_attributes(:content => 'Has this example question been changed?')
      end
